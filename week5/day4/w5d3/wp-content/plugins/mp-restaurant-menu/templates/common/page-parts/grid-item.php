<?php
/**
 * @hooked mprm_page_template_menu_item_grid_before - 10
 */
do_action('mprm_page_template_menu_item_grid_before');

/**
 * Menu page template item grid
 *
 * @hooked mprm_page_template_menu_item_grid - 10
 *
 ...
 *
 */
do_action('mprm_page_template_menu_item_grid');

/**
 * @hooked mprm_page_template_menu_item_grid_after - 10
 */
do_action('mprm_page_template_menu_item_grid_after');
