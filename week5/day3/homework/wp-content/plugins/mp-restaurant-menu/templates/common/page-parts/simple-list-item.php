 ...
 */
do_action('mprm_page_template_menu_item_simple_list_before');


do_action('mprm_page_template_menu_item_simple-list');
 ...
 */
do_action('mprm_page_template_menu_item_simple-list_after');
